...
const ManageProducts = () => {
    const { data: products, isLoading, refetch } = useQuery('products', () => fetch('https://stormy-castle-37919.herokuapp.com/parts', {
        headers: {
    ...
    const handleDelete = (id, name) => {
        fetch(`https://stormy-castle-37919.herokuapp.com/product/${id}`, {
            method: 'DELETE',
            headers: {
                authorization: `Bearer ${localStorage.getItem('accessToken')}`
            }
