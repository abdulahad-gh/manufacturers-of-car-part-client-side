...
const MyOrders = () => {
    ...
    const { data: orders, isLoading, refetch } = useQuery(['orderFind', user.email], () => (fetch(`https://manufacturers-of-car-part-server-huce.vercel.app/orders?email=${user.email}`, {
        method: 'GET',
        headers: {
