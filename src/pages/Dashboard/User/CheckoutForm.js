...
const CheckoutForm = ({ item }) => {
    ...
    useEffect(() => {
        fetch('https://manufacturers-of-car-part-server-huce.vercel.app/create-payment-intent', {
            method: 'POST',
            headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if (intentError) {
            ...
            fetch(`https://manufacturers-of-car-part-server-huce.vercel.app/order/${_id}`, {
                method: 'PATCH',
                headers: {
                    'content-type': 'application/json',
                    'authorization': `Bearer ${localStorage.getItem('accessToken')}`
