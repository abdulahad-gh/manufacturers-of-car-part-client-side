        ...
        <div className='mt-20 px-4 md:px-20'>
            ...
            <div className='flex flex-col gap-5'>
                ...
                <div>
                    ...
                    <p className='font-bold'>Ans: useState return tow value,first is state value, seccond is set new state value. when use useState([]) means initial value of state. when we want to change value of state.we need to call set state function. set new state value to use setProducts name. products is plural,means get more then one element, so initial value is []. when products api is true,using setProducts to set products.</p>
                </div>
                <div>
                    <p className='font-semibold'>Q5. What is a unit test? Why should write unit tests?</p>
                    <p className='font-bold'>Ans: unit test is part of software testing. Unit mean specific area of app, or components os software are tested.Unit Testing is main because software developers sometimes try saving time doing minimal unit testing and this is myth since unfitting unit testing leads to high cost Defect fixing through System Testing, Sociology Testing and even Beta Testing succeeding application is construct.</p>
                </div>
            </div>
