            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                <div class="card lg:max-w-lg bg-base-100 shadow-xl image-full">
                    ...
                    <div class="card-body">
                        ...
                        <p className='flex gap-2'><img className='w-8 h-8 rounded-full' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9fAHBAZDOkAYBUlsgaXK6BPZVRWUfw-ByLQ&usqp=CAU" alt="" /> <span className='italic'>Manufacturers Of Car Part</span>
                        </p>

                    </div>
                </div>
                <div class="card lg:max-w-lg bg-base-100 shadow-xl image-full">
                    <figure><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTk-rjIf5tPpcLSFGbdX_3cL4bRHGEgOC27vw&usqp=CAU" alt="Shoes" /></figure>
                    <div class="card-body">
